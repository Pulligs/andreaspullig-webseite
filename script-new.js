        ...
        <div class="blog-modal-content">
            ...
            <div class="blog-full-content">
                ...
                <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                    ...
                    <tbody>
                        <tr>
                            <td style="padding: 10px; border: 1px solid #ddd;"><strong>Hühnerbrust</strong></td>
                        ...
                        <tr>
                            <td style="padding: 10px; border: 1px solid #ddd;"><strong>Lachs</strong></td>
                            <td style="padding: 10px; border: 1px solid #ddd;">100 g</td>
                            <td style="padding: 10px; border: 1px solid #ddd;">20 g</td>
                        </tr>
                        <tr style="background-color: #f9f9f9;">
                            <td style="padding: 10px; border: 1px solid #ddd;"><strong>Thunfisch</strong></td>
                            <td style="padding: 10px; border: 1px solid #ddd;">100 g</td>
                ...
                <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: #f9f9f9;">
                            <td style="padding: 10px; border: 1px solid #ddd;"><strong>Haferflocken</strong></td>
                            <td style="padding: 10px; border: 1px solid #ddd;">100 g</td>
