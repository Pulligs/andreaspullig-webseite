...
case 0:
    blogContent = `
        <div class="blog-modal-content">
            ...
            <p class="blog-meta">16. November 2025 | Kategorie: Ganzheitliche Medizin</p>
            <div class="blog-full-content">
                ...
                <p>Ich möchte dir eine Studie zeigen, die meine Sicht auf Migräne grundlegend verändert hat.</p>

                <h3>87 Prozent</h3>

                <p>2007 veröffentlichten die Wissenschaftler Maintz und Novak eine bahnbrechende Untersuchung: <strong>87% aller Migräne-Patienten haben einen Mangel an DAO.</strong><sup>1</sup></p>

                <p>DAO steht für Diaminoxidase – ein Enzym, das zum allergrößten Teil in deiner Darmschleimhaut produziert wird. Seine Aufgabe? Histamin abbauen. Histamin kennst du vielleicht als "Allergie-Stoff". Aber Histamin ist viel mehr. Es ist ein Botenstoff, der überall in deinem Körper aktiv ist: im Gehirn, in der Haut, im Magen, in den Blutgefäßen.</p>

                <p>Histamin an sich erfüllt wertvolle Aufgaben, wie alles was unser Körper macht. Dein Körper braucht es. Das Problem entsteht, wenn zu viel davon da ist – und zu wenig DAO, um es wieder abzubauen.</p>

                <p>Dann flutet Histamin dein System. Die Blutgefäße weiten sich. Das Nervensystem wird überreizt. Und irgendwann klopft die Migräne an.</p>
                ...
                <p>Eine randomisierte, doppelblinde Studie aus 2019 zeigte: <strong>Die Einnahme von DAO reduzierte bei Migräne-Patienten mit DAO-Defizit die Häufigkeit, Schwere und Dauer der Attacken.</strong><sup>3</sup></p>
                ...
                <p>• Chronischer Stress (einer der Hauptfaktoren!)<br>
                • Alkohol<br>
                • Bestimmte Medikamente (besonders NSAIDs wie Ibuprofen)<br>
                • Gluten (macht immer ein zeitlich begrenztes Leaky Gut)<br>
                • Zucker und hochverarbeitete Lebensmittel<br>
                • Antibiotika<br>
                • Schlafmangel</p>
                ...
                <p>• Gereifter Käse (Parmesan, Gouda, Camembert)<br>
                • Rotwein und andere alkoholische Getränke<br>
                • Fermentierte Lebensmittel (Sauerkraut, Kimchi, Kombucha)<br>
                • Geräucherter oder konservierter Fisch<br>
                • Wurstwaren und lange gereifte Fleischprodukte<br>
                • Tomaten und Tomatenprodukte<br>
                • Schokolade (besonders dunkle)<br>
                • Zitrusfrüchte<br>
                • Essig und eingelegte Lebensmittel</p>

                <p><strong>Histaminliberatoren</strong> (setzen körpereigenes Histamin frei):</p>

                <p>• Erdbeeren<br>
                • Ananas<br>
                • Nüsse (besonders Walnüsse und Cashews)<br>
                • Hülsenfrüchte</p>
                ...
                <p><strong>Erkennst du dich in diesen Fragen wieder?</strong></p>

                <p>• Du sagst ja, obwohl dein ganzer Körper nein schreit – weil du niemanden enttäuschen willst<br>
                • Du spürst die Emotionen anderer Menschen und nimmst sie auf wie ein Schwamm, bis du nicht mehr weißt, was deine eigenen Gefühle sind<br>
                • Du gibst mehr Energie ab, als du hast – und wunderst dich abends, warum du so erschöpft bist<br>
                • Du gehst ständig über deine eigenen Bedürfnisse hinweg, weil die der anderen "wichtiger" erscheinen<br>
                • Du hast Schwierigkeiten, "Stopp" zu sagen – bei der Arbeit, in Beziehungen, bei Anforderungen<br>
                • Du fühlst dich schuldig, wenn du dir Zeit für dich nimmst<br>
                • Du merkst erst, dass du eine Grenze hattest, wenn sie bereits überschritten wurde</p>

                <p><strong>Frag dich ehrlich:</strong> Wann hast du das letzte Mal Nein gesagt – und es auch durchgezogen, obwohl der andere enttäuscht war? Wann hast du das letzte Mal gespürt, was DU brauchst, bevor du gefragt hast, was die anderen brauchen?</p>
                ...
                <p>1. <strong>Akute Entlastung:</strong> Histaminzufuhr reduzieren + DAO supplementieren<br>
                2. <strong>Darm reparieren:</strong> Cofaktoren auffüllen + Darmschleimhaut unterstützen<br>
                3. <strong>Stress reduzieren:</strong> Echte Grenzarbeit<br>
                4. <strong>Muster erkennen:</strong> Verstehen, wann und warum du über deine Grenzen gehst</p>
                ...
                <h3>Was dieser Artikel nicht ist</h3>

                <p>Dieser Text ist kein Ersatz für eine ärztliche Diagnose. Migräne kann viele Ursachen haben, und nicht jede Migräne ist ganz oder teilweise histaminbedingt. Wenn du unter schweren oder häufigen Migräne-Attacken leidest, solltest du das immer ärztlich abklären lassen.</p>

                <p>Bevor du mit einer Supplementierung beginnst, sprich mit einem Arzt oder Therapeuten, der sich mit Histaminintoleranz auskennt. Die richtige Dosierung und Kombination ist individuell verschieden.</p>

                <h3>Eine Einladung</h3>

                <p>Beobachte in den nächsten Wochen:</p>

                <p>• Wann kommt die Migräne?<br>
                • Was hast du vorher gegessen?<br>
                • Wie war dein Stresslevel?<br>
                • Hast du in den Tagen/Stunden davor Grenzen überschritten?</p>
                ...
                <p><em>Dr. med. Andreas Pullig<br>
                Facharzt für Allgemeinmedizin<br>
                Praxis für Ganzheitliche Medizin, Simmern</em></p>

                <h3>Quellenangaben</h3>

                <p><sup>1</sup> Maintz L, Novak N. Histamine and histamine intolerance. Am J Clin Nutr. 2007;85(5):1185-1196.</p>

                <p><sup>2</sup> Camilleri M. Leaky gut: mechanisms, measurement and clinical implications in humans. Gut. 2019;68(8):1516-1526.</p>

                <p><sup>3</sup> Izquierdo-Casas J, et al. Diamine oxidase (DAO) supplement reduces headache in episodic migraine patients with DAO deficiency: A randomized double-blind trial. Clin Nutr. 2019;38(1):152-158.</p>

                <p><sup>4</sup> Molina Perelló P, et al. Evaluation of the safety and tolerability of three single ascending doses of Diamine oxidase (DAO) in healthy volunteers. medRxiv. 2024.</p>

                <p><sup>5</sup> Mauskop A, Varughese J. Why all migraine patients should be treated with magnesium. J Neural Transm. 2012;119(5):575-579.</p>

                <p><sup>6</sup> Schoenen J, et al. Effectiveness of high-dose riboflavin in migraine prophylaxis. Neurology. 1998;50(2):466-470.</p>

                <p><sup>7</sup> Rao R, Samak G. Role of Glutamine in Protection of Intestinal Epithelial Tight Junctions. J Epithel Biol Pharmacol. 2012;5(Suppl 1-M7):47-54.</p>
