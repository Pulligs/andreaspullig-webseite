   ...
   // Blog-Modal-Funktionalität - VOLLSTÄNDIG
    ...
    blogContent = `
        <div class="blog-modal-content">
            <h2>Erschöpfung: Wenn die Energie fehlt – Eine ganzheitliche Spurensuche</h2>
            ...
            <p class="blog-meta">15. Oktober 2025 | Kategorie: Ganzheitliche Medizin & Orthomolekulare Medizin</p>
            <div class="blog-full-content">
                ...
                <h4 style="color: #5B9BD5;">1. Eisenmangel und Anämie: Der stille Energieräuber</h4>
                ...
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Was gemessen werden sollte:</h5>
                ...
                <p><strong>Besonders betroffen:</strong> Frauen mit starker Menstruation, Vegetarier und Veganer, Menschen mit chronischen Entzündungen, Sportler</p>
                
                <p>➡️ <strong>Mehr dazu im Blog über Eisen</strong></p>
                
                <hr style="border: none; border-top: 1px solid #e0e0e0; margin: 30px 0;">
                
                <h4 style="color: #5B9BD5;">2. Vitamin D-Mangel: Das unterschätzte Hormon</h4>
                
                <p>61,5% der Deutschen haben Vitamin D-Werte unter 50 nmol/l (20 ng/ml). Das RKI gibt das zu. Und empfiehlt trotzdem weiter lächerliche 800 IE täglich.</p>
                
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Was als "normal" gilt vs. was optimal ist:</h5>
                    <ul style="margin-bottom: 0;">
                ...
                <p><strong>Was Sie wissen müssen:</strong> Vitamin D ist kein Vitamin. Es ist ein Hormon. Es steuert über 3.000 Gene. Es braucht Kofaktoren: Magnesium, Vitamin K2, Omega-3.</p>
                
                <p>➡️ <strong>Mehr dazu im Blog über Vitamin D</strong></p>
                
                <hr style="border: none; border-top: 1px solid #e0e0e0; margin: 30px 0;">
                
                <h4 style="color: #5B9BD5;">3. Schilddrüsenunterfunktion und Hashimoto: Das übersehene Chamäleon</h4>
                ...
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Die vollständige Schilddrüsendiagnostik:</h5>
                    <ul style="margin-bottom: 0;">
                        <li><strong>TSH</strong> (OPTIMAL: 0,5-2,0 mU/l, nicht 0,5-4,0!)</li>
                ...
                <p><strong>Typische Hashimoto-Symptome:</strong></p>
                <ul>
                ...
                <p><strong>Warum Hashimoto so oft übersehen wird:</strong> Die Erkrankung beginnt schleichend. Unspezifische Symptome wie Müdigkeit werden als Stress abgetan. Der TSH-Wert liegt bei 3,2 – "hochnormal" – und niemand untersucht die Antikörper.</p>
                ...
                <h4 style="color: #5B9BD5;">4. Chronische Entzündungen und post-virale Erschöpfung: Der lange Schatten</h4>
                ...
                <p><strong>Was Sie wissen sollten:</strong> ME/CFS (Myalgische Enzephalomyelitis / Chronisches Fatigue-Syndrom) ist eine eigenständige schwere Erkrankung, die oft nach Virusinfekten auftritt. Sie ist NICHT psychisch. Sie ist NICHT "nur Müdigkeit". Sie ist eine schwere neurologische und immunologische Erkrankung.</p>
                
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Diagnostik bei chronischen Infektionen:</h5>
                    <ul style="margin-bottom: 0;">
                ...
                <h4 style="color: #5B9BD5;">5. Magnesium-Mangel: Der unterschätzte Cofaktor</h4>
                ...
                <p><strong>Wer ist besonders betroffen:</strong></p>
                <ul>
                ...
                <p>➡️ <strong>Mehr dazu im Blog über Magnesium</strong></p>
                
                <hr style="border: none; border-top: 1px solid #e0e0e0; margin: 30px 0;">
                
                <h4 style="color: #5B9BD5;">6. Omega-3-Mangel: Die unterschätzte Erschöpfungsursache</h4>
                ...
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Omega-3-Index messen:</h5>
                ...
                <p><strong>Besonders betroffen:</strong> Menschen, die wenig oder keinen Fisch essen, Vegetarier und Veganer, Menschen mit chronischen Entzündungen, Menschen mit hohem Omega-6-Konsum</p>
                
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Empfohlene Tagesdosis:</h5>
                    <ul style="margin-bottom: 0;">
                ...
                <h4 style="color: #5B9BD5;">7. HPA-Achsen-Dysfunktion: Wenn die Stressachse erschöpft ist</h4>
                ...
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Diagnostik bei HPA-Achsen-Dysfunktion:</h5>
                    ...
                    <ul style="margin-bottom: 0;">
                        <li><strong>Cortisol-Tagesprofil</strong> (Speichel, 4x täglich: morgens, mittags, nachmittags, abends)</li>
                ...
                <h4 style="color: #5B9BD5;">Oxidativer Stress: Der gemeinsame Nenner</h4>
                ...
                <div style="background-color: #f5f5f5; border-left: 4px solid #5B9BD5; padding: 20px; margin: 20px 0;">
                    <h5 style="color: #284261; margin-top: 0;">Basis-Labor:</h5>
                    <ul>
                        <li><strong>Kleines Blutbild + Differentialblutbild</strong><br>Hämoglobin, Erythrozyten, Leukozyten, Thrombozyten</li>
                    </ul>
                    
                    <h5 style="color: #284261; margin-top: 20px;">Eisenstoffwechsel komplett:</h5>
                    <ul>
                    ...
                    <h5 style="color: #284261; margin-top: 20px;">Schilddrüse komplett:</h5>
                    <ul>
                        <li>TSH (ZIEL: 0,5-2,0 mU/l)</li>
                        <li>fT3, fT4</li>
                        <li>TPO-Antikörper, TG-Antikörper</li>
                    </ul>
                    
                    <h5 style="color: #284261; margin-top: 20px;">Vitamine:</h5>
                    <ul>
                    ...
                    <h5 style="color: #284261; margin-top: 20px;">Entzündungsmarker:</h5>
                    <ul>
                        <li>CRP</li>
                        <li>BSG</li>
                    </ul>
                    
                    <h5 style="color: #284261; margin-top: 20px;">Optional bei Verdacht:</h5>
                    <ul>
                        <li>EBV-Serologie</li>
                        ...
                        <li><strong>Cortisol-Tagesprofil</strong> (Speichel, 4x täglich) – bei Verdacht auf HPA-Achsen-Dysfunktion</li>
                ...
                <h4 style="color: #5B9BD5;">Fragen Sie sich selbst:</h4>
                <ul>
                ...
                <p>In meiner Praxis nehme ich mir Zeit. Nicht, weil ich nett bin. Sondern weil es anders nicht geht. Erschöpfung ist komplex. Sie braucht einen Detektiv, keinen Fließband-Mediziner.</p>
